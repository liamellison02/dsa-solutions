...
- space = O(m*n)
notes:
simple hashing solution:
- use sets for rows, cols, and 3x3 boxes/squares.
- iterate through board, checking that each num is unique w.r.t its associated row/col/box.
"""
