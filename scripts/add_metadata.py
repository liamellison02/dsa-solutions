...
for pid in [1, 9, 20, 21, 67, 78, 110, 121, 125, 141, 150, 206, 226, 242, 252,
            704, 733, 744, 961, 1200, 1266, 3379, 3507, 3637, 3798]:
    LC_DIFFICULTY[str(pid)] = "easy"

for pid in [3, 5, 19, 36, 45, 54, 56, 57, 59, 91, 97, 134, 139, 152, 213, 223,
            235, 238, 253, 271, 286, 300, 309, 329, 332, 347, 362, 435, 490,
            566, 567, 651, 678, 684, 712, 763, 787, 799, 846, 1123, 1161,
            1292, 1339, 1382, 1390, 1458, 1584, 1653, 1899, 1975, 1984,
            2013, 3010, 3047, 3650, 3713, 3714, 3719, 3799, 3800]:
...
def process_file(filepath):
    ...
    if platform == "lc":
        ...
        if diff:
            ...
            print(f"  WARNING: Unknown difficulty for LC #{prob_id} in {filepath}")
...
def main():
    ...
    print(f"\nDone. {modified} files updated, {skipped} files skipped, {total} total files scanned.")
